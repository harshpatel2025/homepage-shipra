;(() => {
  const e = (e) => Math.abs(Number.parseInt(e, 10)),
    t = (e, t) => {
      const a = new Map([
        ["init", "init"],
    ...
    n = (e) => {
      ...
      return r.reduceRight(
        ...
        (e) => {
          ...
          "string" == typeof s &&
            ((n = a.replace(/^\/|\/$/g, "")), (r = s.replace(/^\//, "")), (c = r ? n + "/" + r : n)),
            "string" == typeof c &&
              (-1 !== t.indexOf("?") && (c = c.replace("?", "&")), (c = c.replace(/^\//, "")), (o = t + c)),
      ...
      .then((t) => {
        if (void 0 !== swv) {
          ...
          for (const [a, { error: n, validInputs: r }] of t)
            s(e, a), void 0 !== n && c(e, a, n, { scope: l }), i(e, a, null != r ? r : [])
        }
      })
      .finally(() => {
        t(e, m),
  ...
  const c = (e, t, a, n) => {
    ...
    s = (e, t) => {
      var a, n
      const r = `${null === (a = e.wpcf7) || void 0 === a ? void 0 : a.unitTag}-ve-${t}`.replaceAll(
        /[^0-9a-z_-]+/gi,
        "",
      )
      ...
      ((e) => {
        ...
        const t = () => {
          ...
          e.querySelectorAll(".wpcf7-acceptance").forEach((e) => {
            ...
            ;((e.classList.contains("invert") && a.checked) || (!e.classList.contains("invert") && !a.checked)) &&
              (t = !1)
          }),
