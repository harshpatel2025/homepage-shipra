  ...
  ((t) => {
    ...
    c(
      ...
      e("3.2.0") &&
        (c(
          s,
          "nodeName",
          (e, t) => e.nodeName && e.nodeName.toLowerCase() === t.toLowerCase(),
          "nodeName",
      ...
      e("3.3.0") &&
        ...
        c(s, "isFunction", (e) => "function" == typeof e, "isFunction", "jQuery.isFunction() is deprecated"),
        c(s, "isWindow", (e) => null != e && e === e.window, "isWindow", "jQuery.isWindow() is deprecated")),
      s.ajax &&
        ((l = s.ajax),
        (p = /(=)\?(?=&|$)|\?\?/),
        i(
    ...
    i(
      ...
      function (e) {
        var n = !1
        return (
          s.each(e.match(w), (e, t) => {
            s.expr.match.bool.test(t) &&
              this.each(function () {
                if (!1 !== s(this).prop(t)) return !(n = !0)
              }),
              n &&
                (u("removeAttr-bool", "jQuery.fn.removeAttr no longer sets boolean properties: " + t), this.prop(t, !1))
          }),
    ...
    s.swap &&
      s.each(["height", "width", "reliableMarginRight"], (e, t) => {
      ...
      s.fx &&
        ...
        n.requestAnimationFrame &&
          Object.defineProperty(s.fx, "interval", {
            ...
            enumerable: !0,
            get: () => (
              n.document.hidden || u("fx-interval", P), s.migrateIsPatchEnabled("fx-interval") && void 0 === S ? 13 : S
            ),
            set: (e) => {
              u("fx-interval", P), (S = e)
            },
