;(() => {
    ...
    const e = () => {
      ...
      return (
        ...
        (t.set = (e, s) => {
          "" === e
            ? (e = t.largestIndex++)
            : /^[0-9]+$/.test(e) && ((e = Number.parseInt(e)), t.largestIndex <= e && (t.largestIndex = e + 1)),
    ...
    for (const [t, i] of this.formData) {
      ...
      if (o)
        if ("" === o.groups.array) this.tree.set(o.groups.name, i)
          ...
          const s = t.pop()
          t.reduce((t, s) => {
            if ((/^[0-9]+$/.test(s) && (s = Number.parseInt(s)), t.get(s) instanceof Map)) return t.get(s)
            const i = e()
            return t.set(s, i), i
          }, this.tree).set(s, i)
        }
  ...
  const n = function (t) {
    ...
    h = function (t) {
      if (t.getAll(this.field).length < Number.parseInt(this.threshold)) throw new o(this)
    },
    u = function (t) {
      const e = t.getAll(this.field)
      if (Number.parseInt(this.threshold) < e.length) throw new o(this)
    },
    g = function (t) {
      const e = t.getAll(this.field)
      let s = 0
      if (
        ...
        0 !== s && s < Number.parseInt(this.threshold))
      )
        throw new o(this)
    },
    v = function (t) {
      ...
      if (
        ...
        Number.parseInt(this.threshold) < s)
      )
        throw new o(this)
    },
    w = function (t) {
      if (!t.getAll(this.field).every((t) => !(Number.parseFloat(t) < Number.parseFloat(this.threshold))))
        throw new o(this)
    },
    x = function (t) {
      if (!t.getAll(this.field).every((t) => !(Number.parseFloat(this.threshold) < Number.parseFloat(t))))
        throw new o(this)
    },
    y = function (t) {
      if (
    ...
    A = function (t) {
      ...
      if (
        ...
        s < Number.parseInt(this.threshold))
      )
        throw new o(this)
    },
    z = function (t) {
  ...
  window.swv = {
    ...
    validate: (t, s, n = {}) => {
      const a = (t.rules ?? []).filter(
        ({ rule: t, ...s }) => "function" == typeof e[t] && ("function" != typeof e[t].matches || e[t].matches(s, n)),
      )
